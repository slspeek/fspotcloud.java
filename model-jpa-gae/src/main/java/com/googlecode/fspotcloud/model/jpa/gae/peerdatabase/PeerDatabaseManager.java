...
public class PeerDatabaseManager extends CachedPeerDatabaseManagerBase<PeerDatabase, PeerDatabaseEntity>
    ...
    @Inject
    public PeerDatabaseManager(
        Provider<EntityManager> entityManagerProvider, Cache cache) {
