...
//     PhotoData.class,
      PhotoDataResult.class,
      PhotoRemovedFromTag.class,
      PhotoUpdate.class,
      TagDataResult.class,
      TagRemovedFromPeer.class,
      TagUpdate.class,
    ...
    public void ensureExpectedPojoCount() {
        Affirm.affirmEquals(
            "Classes added / removed?", EXPECTED_CLASS_COUNT, pojoClasses.size());
    }
