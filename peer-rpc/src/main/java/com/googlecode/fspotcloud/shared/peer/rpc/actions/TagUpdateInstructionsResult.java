...
public class TagUpdateInstructionsResult extends BusinessBase implements Result, Serializable {
    ...
    public TagUpdateInstructionsResult(
        List<PhotoUpdate> toBoUpdated,
