...
public class RasterActionsImpl extends ActionsFactory implements
	...
	private void init() {
		...
		REMOVE_COLUMN = createRaster("remove-column", "Remove column", 'X', null,
				"Removes one column from the raster", resources.removeColumnIcon(),
