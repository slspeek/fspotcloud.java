...
public enum ApplicationType implements ActionDef {
    TOGGLE_HELP(
        "help", "Help", "Display a popup with the keyboard shortcuts",
        new KeyStroke('H'), null), 
    ZOOM_IN(
        "zoom-in", "Zoom in", "Zoom into the current image", new KeyStroke(107),
        null), 
    ZOOM_OUT(
        "zoom-out", "Zoom out", "Zoom out of the current image",
    ...
    DASHBOARD(
        "dashboard", "Dashboard", "Go to the dashboard (admin only)",
        new KeyStroke('D'), null), 
    ABOUT(
        "about", "About", "About this open source project", new KeyStroke('A'),
        null), 
    HIDE_CONTROLS(
        "hide-controls", "Hide controls", "Hide treeview", new KeyStroke('F'),
        null), 
