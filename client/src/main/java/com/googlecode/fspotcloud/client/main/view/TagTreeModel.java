...
public class TagTreeModel implements TreeViewModel {
    private static final Logger log = Logger.getLogger(
            TagTreeModel.class.getName());
    List<TagNode> roots;
    SelectionModel<TagNode> selectionModel;
    Provider<Cell<TagNode>> cellProvider;

    public TagTreeModel(
        List<TagNode> roots, SelectionModel<TagNode> selectionModel,
        Provider<Cell<TagNode>> cellProvider) {
        super();
        this.roots = roots;
    ...
    public <T> NodeInfo<?> getNodeInfo(T value) {
        if (value == null) {
            ...
            return new DefaultNodeInfo<TagNode>(
                rootNodes, cellProvider.get(), selectionModel, null);
            ...
            return new DefaultNodeInfo<TagNode>(
                childNodes, cellProvider.get(), selectionModel, null);
        } else {
