...
public abstract class CachedPeerDatabaseManagerBase<T extends PeerDatabase, U extends T>
    ...
    private static final Logger log = Logger.getLogger(
            CachedPeerDatabaseManagerBase.class.getName());
    private final Provider<EntityManager> entityManagerProvider;

    @Inject
    public CachedPeerDatabaseManagerBase(
        Class<U> entityType, Cache cache,
        Provider<EntityManager> entityManagerProvider) {
        super(
            entityType, cache,
            new SimpleDAONamedIdImpl<PeerDatabase, U, String>(
                entityType, entityManagerProvider));
